    ...
    <main>
      <header className='flex flex-col items-center fixed top-0 w-full z-40 pt-[70px]'>
        <div className='mt-40 flex flex-col justify-evenly'>
          ...
          <div className="flex justify-evenly mt-20 animate-fade-up animate-once animate-duration-1000 animate-delay-700 animate-ease-in-out delay-[2000ms] ">
            <Link href="/register" className="bg-sky-500 tex-white py-2 px-5 text-xl rounded-md hover:bg-sky-900">Empieza ya</Link>
            <Link href="/precios" className="bg-white/80 text-black py-2 px-5 text-xl rounded-md hover:bg-black hover:text-gray-100">Más información</Link>
          </div>
        </div>
      </header>
