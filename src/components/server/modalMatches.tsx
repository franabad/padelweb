  ...
  return (
    <div className='overlay bg-black/50 fixed w-full h-full top-0 left-0 flex items-center justify-center'>
      <div ref={modalRef} className='modalcontainer rounded-xl bg-slate-950 py-20 px-32 shadow-[0px_0px_10px_10px_#000000]'>
        ...
        <p className='text-white mb-3'>Jugador 1: {matchData?.p1}</p>
        <p className='text-white mb-3'>Jugador 2: {matchData?.p2}</p>
        <p className='text-white mb-3'>Jugador 3: {matchData?.p3}</p>
        <p className='text-white mb-3'>Jugador 4: {matchData?.p4}</p>
